...
#define COCOAPODS_VERSION_MAJOR_MRGPagerController 0
#define COCOAPODS_VERSION_MINOR_MRGPagerController 1
#define COCOAPODS_VERSION_PATCH_MRGPagerController 0
